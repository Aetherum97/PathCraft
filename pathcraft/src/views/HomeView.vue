...
<template>
  <div class="stagger max-w-3xl mx-auto px-6 py-8 space-y-6">
    ...
    <section class="relative pt-4 pb-2">
      ...
      <p class="mt-5 max-w-[480px] text-[15px] leading-relaxed" :style="{ color: muted }">
    ...
    >
      ...
      >
        Tribuneo v2 — refonte du tableau de bord employeur en <em style="color: var(--accent)">Vue 3</em>.
      </div>
    </section>
